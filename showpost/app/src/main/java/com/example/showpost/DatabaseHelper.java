        ...
        try{
            ...
            if(objectCursor!=null && objectCursor.getCount()>0){
                while (objectCursor.moveToNext()) {
                    ...
                    objectModelClassList.add(new com.example.showpost.ModelClass(postid,nameOfImage,objectBitmap));
                }
            ...
            if(objectCursor!=null && objectCursor.getCount()!=0){
                while (objectCursor.moveToNext()) {
                   ...
                   // Bitmap objectBitmap = BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.length);
                    ...
                    //objectModelClassList1.add(new com.example.showpost.modelc1(topicinfo));
